...
public class LockedObject {
	...
	public String toString() {
    	String separator = ", ";
		return "LockedObject ["
				+ "_path=" + _path + separator 
				+ "_id=" + _id + separator 
				+ "_lockDepth=" + _lockDepth + separator
				+ "_expiresAt=" + new Date(_expiresAt) + separator
				+ "_owner="	+ Arrays.toString(_owner) + separator
				+ "_children=" + Arrays.toString(_children) + separator
				+ "_parent=" + ((_parent==null)?"null":"not null") + separator
				+ "_exclusive=" + _exclusive + separator
				+ "_type=" + _type
				+ "]";
	}
